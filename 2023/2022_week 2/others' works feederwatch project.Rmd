---
title: "others' works tidytuesday_week 2_FeederWatch project"
author: "birasafab"
date: "2023-01-11"
...
[Work by rennie](https://github.com/nrennie/tidytuesday/blob/main/2023/2023-01-10/20230110.R) [her twitter's post](https://twitter.com/nrennie35/status/1612740418206306310).
...
## How to highlight some parts on the map?

```{r}
#highlighter = usa_map %>% filter(grepl("santa cruz",ID))

#highlighter = highlighter$ID


highlighter = c("santa cruz","san francisco","san joaquin", "alpine")

highlighter = paste("california",highlighter, sep = ",")

usa_map$highlighter = ifelse(usa_map$ID %in% highlighter,"highlighted","not_highlighted")
